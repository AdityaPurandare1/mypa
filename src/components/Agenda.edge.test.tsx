...
describe('Agenda — overflow (no silent task loss)', () => {
  it('renders ALL plannable tasks even when more than targetPerDay (6)', () => {
    ...
    render(<Agenda tasks={tasks} onComplete={noop} onReopen={noop} onSnooze={noop} onDelete={noop} onEdit={noop} onSetSteps={noop} />);
...
describe('Agenda — actions & progress', () => {
  ...
  it('onEdit fires with the task when the title is tapped', () => {
    ...
    render(<Agenda tasks={[t]} onComplete={noop} onReopen={noop} onSnooze={noop} onDelete={noop} onEdit={onEdit} onSetSteps={noop} />);
  ...
  it('reflects a completed-today task in the "done" count', () => {
    ...
    render(<Agenda tasks={[doneToday, open]} onComplete={noop} onReopen={noop} onSnooze={noop} onDelete={noop} onEdit={noop} onSetSteps={noop} />);
  ...
  it('snooze +1d fires with a future ISO for an already-open task', () => {
    ...
    render(<Agenda tasks={[t]} onComplete={noop} onReopen={noop} onSnooze={onSnooze} onDelete={noop} onEdit={noop} onSetSteps={noop} />);
  ...
  it('delete fires with the right id', () => {
    ...
    render(<Agenda tasks={[t]} onComplete={noop} onReopen={noop} onSnooze={noop} onDelete={onDelete} onEdit={noop} onSetSteps={noop} />);
