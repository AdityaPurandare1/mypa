...
describe('Agenda — overflow (no silent task loss)', () => {
  it('renders ALL plannable tasks even when more than targetPerDay (6)', () => {
    ...
    render(<Agenda tasks={tasks} onComplete={noop} onSnooze={noop} onDelete={noop} onEdit={noop} />);
...
describe('Agenda — actions & progress', () => {
  ...
  it('onEdit fires with the task when the title is tapped', () => {
    ...
    render(<Agenda tasks={[t]} onComplete={noop} onSnooze={noop} onDelete={noop} onEdit={onEdit} />);
  ...
  it('reflects a completed-today task in the "done" count', () => {
    ...
    render(<Agenda tasks={[doneToday, open]} onComplete={noop} onSnooze={noop} onDelete={noop} onEdit={noop} />);
  ...
  it('snooze +1d fires with a future ISO for an already-open task', () => {
    ...
    render(<Agenda tasks={[t]} onComplete={noop} onSnooze={onSnooze} onDelete={noop} onEdit={noop} />);
  ...
  it('delete fires with the right id', () => {
    ...
    render(<Agenda tasks={[t]} onComplete={noop} onSnooze={noop} onDelete={onDelete} onEdit={noop} />);
